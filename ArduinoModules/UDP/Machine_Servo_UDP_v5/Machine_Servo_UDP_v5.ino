...
///////////R�gler ici la position d'ouverture, fermeture et neutre de vos servotmoteur (dans l'orde de 1 � 16)/////////////
uint8_t positionOpen[] = { 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15 };   //position ouvert en degr�
uint8_t positionNeutral[] = { 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90 };   //position neutre en degr�
