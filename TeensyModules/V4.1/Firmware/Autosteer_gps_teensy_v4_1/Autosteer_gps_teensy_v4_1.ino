...
HardwareSerial* SerialGPS = &Serial5; //7  //Main postion receiver (GGA) (Serial2 must be used here with T4.0 / Basic Panda boards - Should auto swap)
...
//CNH
byte goPress[8]   = {0x82, 0x00, 0x34, 0x00, 0xFF, 0xC0, 0x0F, 0xF0};  //press big go
byte goLift[8]    = {0x82, 0x00, 0x30, 0x00, 0xFF, 0xC0, 0x0F, 0xF0};  //lift big go
byte endPress[8]  = {0x82, 0x00, 0x31, 0x00, 0xFF, 0xC0, 0x0F, 0xF0};  //press big end
byte endLift[8]   = {0x82, 0x00, 0x30, 0x00, 0xFF, 0xC0, 0x0F, 0xF0};  //lift big end
